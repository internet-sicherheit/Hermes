 ...
 */
class JobControllerIntSpec extends IntegrationSpec {
    ...
    void "test deleteModal with null parameter"() {
        ...
        then:
            ...
            controller.response.text == g.message(code: C.DEFAULT_NOT_FOUND_MESSAGE_CODE, args: [g.message(code: C.JOB_LABEL_CODE), null])
    }
    ...
    void "test deleteModal with invalid id"() {
        ...
        then:
            controller.response.status == SEC.NOT_FOUND_CODE
            controller.response.text == g.message(code: C.DEFAULT_NOT_FOUND_MESSAGE_CODE, args: [g.message(code: C.JOB_LABEL_CODE), 0])
    }
