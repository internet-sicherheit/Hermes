 ...
 */
class HypervisorControllerIntSpec extends IntegrationSpec {
    ...
    void "test deleteModal with null parameter"() {
        setup:
            controller = new HypervisorController()
        ...
        then:
            ...
            controller.response.text == g.message(code: C.DEFAULT_NOT_FOUND_MESSAGE_CODE, args: [g.message(code: C.HYPERVISOR_LABEL_CODE), null])
    }
    ...
    void "test deleteModal with invalid id"() {
        ...
        then:
            controller.response.status == SEC.NOT_FOUND_CODE
            controller.response.text == g.message(code: C.DEFAULT_NOT_FOUND_MESSAGE_CODE, args: [g.message(code: C.HYPERVISOR_LABEL_CODE), 0])
    }
    ...
    void "test initDataTable"() {
        ...
        then:
            controller.response.status == 200
            controller.response.json.size() != null
    }
}
